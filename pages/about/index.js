      ...
      <Layout>
        <div>
          ...
          <div className="section">
            <div className="box">
              <div className="grid grid-cols-2 grid-cols-4 gapx-12">
                <div className="text-center">
                  <p className="text-xl lg:text-4xl fw-600">100k+</p>
                  <p className="mt-5 fw-500 lg:fs-700">Home Residents</p>
                </div>
                <div className="text-center">
                  <p className="text-xl lg:text-4xl fw-600">1500km+</p>
                  <p className="mt-5 fw-500 lg:fs-700">Areas Covered</p>
                </div>
                <div className="text-center">
                  <p className="text-xl lg:text-4xl fw-600">200+</p>
                  <p className="mt-5 fw-500 lg:fs-700">Waste Trucks</p>
                </div>
                <div className="text-center">
                  <p className="text-xl lg:text-4xl fw-600">70+</p>
          ...
          <div className="section">
            <div className="box">
              <div>
                <p className="text-center lg:w-4/12 mx-auto text-xl lg:text-4xl fw-600">
                  Get the App for free and Start Now
                </p>
                <p className="w-7/12 mx-auto fw-500 mt-4 text-center">
